...
import { Turno, Turma, turmasPorTurno } from '../models/user.model';

const usuarioRegex = /^[a-z0-9.]{8,}$/;
const senhaRegex = /^(?=.*[A-Za-z])(?=.*\d).{8,}$/;

// Valida as entradas publicas das rotas de autenticacao.
export const registerSchema = z
  .object({
    ...
    dataNascimento: z.coerce.date({ invalid_type_error: 'Data de nascimento invalida' }),
