...
export function Textarea({ className, error, id, label, ...props }: TextareaProps) {
  ...
  return (
    <label className="block" htmlFor={inputId}>
      ...
      <textarea
        className={cn(
          'portal-field mt-2 min-h-28 w-full resize-none rounded-2xl border px-4 py-3.5 text-sm font-medium text-brand-navy outline-none transition-all placeholder:text-slate-400 focus:-translate-y-0.5 focus:ring-4',
          error
